...
pub fn drc20_activation_height(network: &DogecoinNetwork) -> u64 {
    match network {
        // Keep DRC-20 gated behind Doginals activation on Dogecoin mainnet.
        DogecoinNetwork::Mainnet => 4_600_000,
        DogecoinNetwork::Regtest => 0,
        DogecoinNetwork::Testnet => 4_250_000,
        DogecoinNetwork::Signet => u64::MAX,
    }
}

pub fn drc20_self_mint_activation_height(network: &DogecoinNetwork) -> u64 {
    match network {
        // Follow the same activation gate until a Dogecoin-specific self-mint
        // height is defined.
        DogecoinNetwork::Mainnet => 4_600_000,
        DogecoinNetwork::Regtest => 0,
        DogecoinNetwork::Testnet => 4_250_000,
