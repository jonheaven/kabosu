...
impl TestBlockBuilder {
    ...
    pub fn transactions(mut self, transactions: Vec<DogecoinTransactionData>) -> Self {
        self.transactions = transactions;
        self
    }

    pub fn add_transaction(mut self, transaction: DogecoinTransactionData) -> Self {
        self.transactions.push(transaction);
        self
    }

    pub fn build(&self) -> DogecoinBlockData {
        DogecoinBlockData {
...
impl TestTransactionBuilder {
    ...
    pub fn drc20_operation(mut self, drc20_operation: Option<Drc20Operation>) -> Self {
        self.drc20_operation = drc20_operation;
        self
    }

    pub fn build(self) -> DogecoinTransactionData {
