...
use super::{super::BlockchainEventExpectation, dogecoin_blocks};
use crate::{
...
pub fn get_vector_001() -> Vec<(DogecoinBlockData, BlockchainEventExpectation)> {
    vec![
        (
            dogecoin_blocks::A1(None),
            expect_chain_updated_with_block(dogecoin_blocks::A1(None), vec![]),
        ),
        (
            dogecoin_blocks::B1(None),
            expect_chain_updated_with_block(dogecoin_blocks::B1(None), vec![]),
        ),
        (
            dogecoin_blocks::C1(None),
            expect_chain_updated_with_block(dogecoin_blocks::C1(None), vec![]),
        ),
    ]
}
...
pub fn get_vector_002() -> Vec<(DogecoinBlockData, BlockchainEventExpectation)> {
    vec![
        ...
        (
            dogecoin_blocks::B2(None),
            expect_chain_updated_with_block_reorg(
                vec![dogecoin_blocks::B1(None)],
                vec![dogecoin_blocks::B2(None)],
                vec![],
            ),
        ),
        (
            ...
            expect_chain_updated_with_block_reorg(
                vec![dogecoin_blocks::B2(None)],
                vec![dogecoin_blocks::B1(None), dogecoin_blocks::C1(None)],
                vec![],
            ),
        ),
        (
            dogecoin_blocks::C2(None),
            expect_chain_updated_with_block_reorg(
                vec![dogecoin_blocks::B1(None), dogecoin_blocks::C1(None)],
                vec![dogecoin_blocks::B2(None), dogecoin_blocks::C2(None)],
                vec![],
            ),
        ),
    ]
...
pub fn get_vector_003() -> Vec<(DogecoinBlockData, BlockchainEventExpectation)> {
    vec![
        ...
        (dogecoin_blocks::B2(None), expect_no_chain_update()),
        (
            dogecoin_blocks::C2(None),
            expect_chain_updated_with_block_reorg(
                vec![dogecoin_blocks::B1(None), dogecoin_blocks::C1(None)],
...
pub fn get_vector_005() -> Vec<(DogecoinBlockData, BlockchainEventExpectation)> {
    vec![
        ...
        (
            dogecoin_blocks::E1(None),
            expect_chain_updated_with_block(dogecoin_blocks::E1(None), vec![]),
        ),
    ]
}
...
pub fn get_vector_006() -> Vec<(DogecoinBlockData, BlockchainEventExpectation)> {
    vec![
        ...
        (
            dogecoin_blocks::F1(None),
            expect_chain_updated_with_block(dogecoin_blocks::F1(None), vec![]),
        ),
    ]
}
...
pub fn get_vector_007() -> Vec<(DogecoinBlockData, BlockchainEventExpectation)> {
    vec![
        ...
        (
            dogecoin_blocks::G1(None),
            expect_chain_updated_with_block(
                dogecoin_blocks::G1(None),
                vec![dogecoin_blocks::A1(None)],
            ),
        ),
    ]
}
...
pub fn get_vector_009() -> Vec<(DogecoinBlockData, BlockchainEventExpectation)> {
    vec![
        ...
        (
            dogecoin_blocks::I1(None),
            expect_chain_updated_with_block(
                dogecoin_blocks::I1(None),
                vec![dogecoin_blocks::C1(None)],
            ),
        ),
    ]
}
...
pub fn get_vector_011() -> Vec<(DogecoinBlockData, BlockchainEventExpectation)> {
    vec![
        ...
        (dogecoin_blocks::E3(None), expect_no_chain_update()),
        (
            dogecoin_blocks::G1(None),
            expect_chain_updated_with_block(
                dogecoin_blocks::G1(None),
...
pub fn get_vector_012() -> Vec<(DogecoinBlockData, BlockchainEventExpectation)> {
    vec![
        ...
        (dogecoin_blocks::F3(None), expect_no_chain_update()),
        (
            dogecoin_blocks::H1(None),
            expect_chain_updated_with_block(
                dogecoin_blocks::H1(None),
        ...
        (dogecoin_blocks::D2(None), expect_no_chain_update()),
    ]
}
...
pub fn get_vector_013() -> Vec<(DogecoinBlockData, BlockchainEventExpectation)> {
    vec![
        ...
        (dogecoin_blocks::G3(None), expect_no_chain_update()),
        (
            dogecoin_blocks::I1(None),
            expect_chain_updated_with_block(
                dogecoin_blocks::I1(None),
...
pub fn get_vector_014() -> Vec<(DogecoinBlockData, BlockchainEventExpectation)> {
    vec![
        ...
        (dogecoin_blocks::H3(None), expect_no_chain_update()),
    ]
}
...
pub fn get_vector_015() -> Vec<(DogecoinBlockData, BlockchainEventExpectation)> {
    vec![
        ...
        (
            dogecoin_blocks::E3(Some(dogecoin_blocks::D1(None))),
        ...
        (
            ...
            expect_chain_updated_with_block_reorg(
                ...
                vec![
                    dogecoin_blocks::E3(Some(dogecoin_blocks::D1(None))),
                    dogecoin_blocks::F3(None),
                    dogecoin_blocks::G3(None),
                    dogecoin_blocks::H3(None),
                    dogecoin_blocks::I3(None),
                ],
                vec![],
            ),
...
pub fn get_vector_017() -> Vec<(DogecoinBlockData, BlockchainEventExpectation)> {
    vec![
        ...
        (dogecoin_blocks::D2(None), expect_no_chain_update()),
        (dogecoin_blocks::E2(None), expect_no_chain_update()),
        (dogecoin_blocks::F2(None), expect_no_chain_update()),
        (dogecoin_blocks::G2(None), expect_no_chain_update()),
    ]
}
...
pub fn get_vector_018() -> Vec<(DogecoinBlockData, BlockchainEventExpectation)> {
    vec![
        ...
        (
            dogecoin_blocks::F3(None),
            expect_chain_updated_with_block_reorg(
                vec![dogecoin_blocks::E1(None), dogecoin_blocks::F1(None)],
                vec![
                    dogecoin_blocks::E3(Some(dogecoin_blocks::D1(None))),
                    dogecoin_blocks::F3(None),
                ],
        ...
        (
            ...
            expect_chain_updated_with_block_reorg(
                ...
                vec![
                    dogecoin_blocks::B2(None),
                    dogecoin_blocks::C2(None),
                    dogecoin_blocks::D2(None),
                    dogecoin_blocks::E2(None),
                    dogecoin_blocks::F2(None),
                    dogecoin_blocks::G2(None),
                ],
                vec![dogecoin_blocks::A1(None)],
            ),
...
pub fn get_vector_019() -> Vec<(DogecoinBlockData, BlockchainEventExpectation)> {
    vec![
        ...
        (dogecoin_blocks::G1(None), expect_no_chain_update()),
    ]
}
...
pub fn get_vector_021() -> Vec<(DogecoinBlockData, BlockchainEventExpectation)> {
    vec![
        ...
        (dogecoin_blocks::C1(None), expect_no_chain_update()),
        (
            dogecoin_blocks::B1(None),
...
pub fn get_vector_022() -> Vec<(DogecoinBlockData, BlockchainEventExpectation)> {
    vec![
        ...
        (dogecoin_blocks::C2(None), expect_no_chain_update()),
        (
            dogecoin_blocks::B2(None),
            expect_chain_updated_with_block_reorg(
                vec![dogecoin_blocks::B1(None), dogecoin_blocks::C1(None)],
...
pub fn get_vector_023() -> Vec<(DogecoinBlockData, BlockchainEventExpectation)> {
    vec![
        ...
        (
            dogecoin_blocks::B2(None),
            expect_chain_updated_with_block(dogecoin_blocks::B2(None), vec![]),
        ),
        (dogecoin_blocks::C1(None), expect_no_chain_update()),
        (
            dogecoin_blocks::C2(None),
            expect_chain_updated_with_block(dogecoin_blocks::C2(None), vec![]),
        ),
        (
            dogecoin_blocks::B1(None),
            expect_chain_updated_with_block_reorg(
...
pub fn get_vector_024() -> Vec<(DogecoinBlockData, BlockchainEventExpectation)> {
    vec![
        ...
        (
            dogecoin_blocks::D1(None),
            expect_chain_updated_with_block(dogecoin_blocks::D1(None), vec![]),
        ),
    ]
}
...
pub fn get_vector_026() -> Vec<(DogecoinBlockData, BlockchainEventExpectation)> {
    vec![
        ...
        (dogecoin_blocks::F1(None), expect_no_chain_update()),
        (dogecoin_blocks::E1(None), expect_no_chain_update()),
        (
            dogecoin_blocks::D1(None),
            expect_chain_updated_with_block_reorg(
                vec![dogecoin_blocks::B2(None), dogecoin_blocks::C2(None)],
...
pub fn get_vector_028() -> Vec<(DogecoinBlockData, BlockchainEventExpectation)> {
    vec![
        ...
        (dogecoin_blocks::F1(None), expect_no_chain_update()),
        (dogecoin_blocks::D1(None), expect_no_chain_update()),
        (dogecoin_blocks::H1(None), expect_no_chain_update()),
        (dogecoin_blocks::G1(None), expect_no_chain_update()),
        (dogecoin_blocks::E1(None), expect_no_chain_update()),
        (
            dogecoin_blocks::B2(None),
    ...
    vec![
        ...
        (
            ...
            expect_chain_updated_with_blocks(
                ...
                vec![dogecoin_blocks::A1(None), dogecoin_blocks::B1(None)],
            ),
        ),
        (
            dogecoin_blocks::I1(None),
            expect_chain_updated_with_blocks(
                vec![dogecoin_blocks::I1(None)],
                vec![dogecoin_blocks::C1(None)],
            ),
        ),
    ]
...
pub fn get_vector_030() -> Vec<(DogecoinBlockData, BlockchainEventExpectation)> {
    vec![
        ...
        (dogecoin_blocks::I1(None), expect_no_chain_update()),
        (dogecoin_blocks::H1(None), expect_no_chain_update()),
        (dogecoin_blocks::G1(None), expect_no_chain_update()),
        (dogecoin_blocks::F1(None), expect_no_chain_update()),
        (dogecoin_blocks::E1(None), expect_no_chain_update()),
...
pub fn get_vector_031() -> Vec<(DogecoinBlockData, BlockchainEventExpectation)> {
    vec![
        ...
        (
            dogecoin_blocks::B2(None),
            expect_chain_updated_with_blocks(vec![dogecoin_blocks::B2(None)], vec![]),
        ),
        (dogecoin_blocks::E1(None), expect_no_chain_update()),
        (
            dogecoin_blocks::C2(None),
            expect_chain_updated_with_blocks(vec![dogecoin_blocks::C2(None)], vec![]),
        ),
        (dogecoin_blocks::D1(None), expect_no_chain_update()),
        (dogecoin_blocks::C1(None), expect_no_chain_update()),
        (
        ...
        (
            dogecoin_blocks::F1(None),
            expect_chain_updated_with_blocks(vec![dogecoin_blocks::F1(None)], vec![]),
        ),
        (dogecoin_blocks::C2(None), expect_no_chain_update()),
        (dogecoin_blocks::I1(None), expect_no_chain_update()),
        (
        ...
        (
            dogecoin_blocks::H1(None),
            expect_chain_updated_with_blocks(
                vec![dogecoin_blocks::H1(None), dogecoin_blocks::I1(None)],
                vec![dogecoin_blocks::B1(None), dogecoin_blocks::C1(None)],
            ),
        ),
    ]
...
pub fn get_vector_032() -> Vec<(DogecoinBlockData, BlockchainEventExpectation)> {
    vec![
        ...
        (
            dogecoin_blocks::B1(None),
            expect_chain_updated_with_blocks(vec![dogecoin_blocks::B1(None)], vec![]),
        ),
        (
            dogecoin_blocks::B2(None),
            expect_chain_updated_with_block_reorg(
        ...
        (dogecoin_blocks::C2(None), expect_no_chain_update()),
        (
            dogecoin_blocks::D3(Some(dogecoin_blocks::C1(None))),
            expect_chain_updated_with_block_reorg(
                vec![dogecoin_blocks::D1(None)],
                vec![dogecoin_blocks::D3(Some(dogecoin_blocks::C1(None)))],
                vec![],
            ),
        ),
        (
            ...
            expect_chain_updated_with_block_reorg(
                vec![dogecoin_blocks::D3(Some(dogecoin_blocks::C1(None)))],
                vec![dogecoin_blocks::D1(None), dogecoin_blocks::E1(None)],
                vec![],
            ),
        ),
        (
            dogecoin_blocks::E3(None),
            expect_chain_updated_with_block_reorg(
                vec![dogecoin_blocks::D1(None), dogecoin_blocks::E1(None)],
                vec![
                    dogecoin_blocks::D3(Some(dogecoin_blocks::C1(None))),
...
pub fn get_vector_033() -> Vec<(DogecoinBlockData, BlockchainEventExpectation)> {
    vec![
        ...
        (dogecoin_blocks::B1(None), expect_no_chain_update()),
        (
            dogecoin_blocks::C1(None),
            expect_chain_updated_with_block_reorg(
                vec![dogecoin_blocks::B2(None), dogecoin_blocks::C2(None)],
...
pub fn get_vector_034() -> Vec<(DogecoinBlockData, BlockchainEventExpectation)> {
    vec![
        ...
        (dogecoin_blocks::E1(None), expect_no_chain_update()),
        (dogecoin_blocks::D3(None), expect_no_chain_update()),
        (dogecoin_blocks::F1(None), expect_no_chain_update()),
        (
            dogecoin_blocks::C3(Some(dogecoin_blocks::B1(None))),
            expect_no_chain_update(),
        ),
        (dogecoin_blocks::G1(None), expect_no_chain_update()),
        (dogecoin_blocks::D1(None), expect_no_chain_update()),
...
pub fn get_vector_035() -> Vec<(DogecoinBlockData, BlockchainEventExpectation)> {
    vec![
        ...
        (
            ...
            expect_chain_updated_with_block_reorg(
                vec![dogecoin_blocks::C1(None)],
                vec![dogecoin_blocks::C3(Some(dogecoin_blocks::B1(None)))],
                vec![],
            ),
        ),
        (
            dogecoin_blocks::D3(None),
            expect_chain_updated_with_blocks(vec![dogecoin_blocks::D3(None)], vec![]),
        ),
        (dogecoin_blocks::D1(None), expect_no_chain_update()),
        (dogecoin_blocks::F3(None), expect_no_chain_update()),
        (
...
pub fn get_vector_037() -> Vec<(DogecoinBlockData, BlockchainEventExpectation)> {
    vec![
        ...
        (dogecoin_blocks::D2(None), expect_no_chain_update()),
        (dogecoin_blocks::B3(None), expect_no_chain_update()),
        (
            dogecoin_blocks::C3(None),
            expect_chain_updated_with_block_reorg(
                vec![dogecoin_blocks::B1(None), dogecoin_blocks::C1(None)],
                vec![dogecoin_blocks::B3(None), dogecoin_blocks::C3(None)],
                vec![],
            ),
        ),
        (
...
pub fn get_vector_038() -> Vec<(DogecoinBlockData, BlockchainEventExpectation)> {
    vec![
        ...
        (dogecoin_blocks::E3(None), expect_no_chain_update()),
        (dogecoin_blocks::D3(None), expect_no_chain_update()),
        (dogecoin_blocks::C3(None), expect_no_chain_update()),
        (dogecoin_blocks::G2(None), expect_no_chain_update()),
        (dogecoin_blocks::F2(None), expect_no_chain_update()),
        (dogecoin_blocks::E2(None), expect_no_chain_update()),
        (dogecoin_blocks::D2(None), expect_no_chain_update()),
...
pub fn get_vector_041() -> Vec<(DogecoinBlockData, BlockchainEventExpectation)> {
    ...
    let b1 = dogecoin_blocks::B1(None);
    let c2 = dogecoin_blocks::C2(Some(b1.clone()));
    let d2 = dogecoin_blocks::D2(Some(c2.clone()));
    let e2 = dogecoin_blocks::E2(Some(d2.clone()));
    let f2 = dogecoin_blocks::F2(Some(e2.clone()));
    let g2 = dogecoin_blocks::G2(Some(f2.clone()));
    ...
    vec![
        ...
        (
            ...
            expect_chain_updated_with_block_reorg(
                vec![c2.clone()],
                vec![dogecoin_blocks::C1(None), dogecoin_blocks::D1(None)],
                vec![],
            ),
        ),
        ...
        (
            g2.clone(),
            expect_chain_updated_with_block(g2.clone(), vec![dogecoin_blocks::A1(None)]),
        ),
    ]
}
